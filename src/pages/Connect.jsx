    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen pt-20 bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="text-center mb-10 px-4">
          ...
          <p className="text-xl text-white/60">Konsultasi pertanian Desa Sumberarum, Kabupaten Blitar</p>
        </motion.div>

        {/* CARD */}
        <div className="flex justify-center items-center min-h-[70vh]">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} className="max-w-md w-full backdrop-blur-xl bg-white/5 rounded-2xl overflow-hidden border border-white/10 pt-20 pb-8">
            <div className="p-6 flex flex-col items-center">
              {/* FOTO */}
              <div className="w-32 h-32 -mt-14 mb-4 relative">
                <div className="absolute inset-0 rounded-full shadow-lg"></div>
                <img src={contact.imageUrl} alt={contact.name} className="w-full h-full rounded-full object-cover border-4 border-white/10 shadow-xl" />
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-white/70 text-sm mb-2">{contact.role}</p>

                <p className="text-white/60 text-sm mb-6">{contact.description}</p>
