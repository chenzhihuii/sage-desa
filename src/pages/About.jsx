      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.2 }}>
            <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4">Misi Kami</h2>
      ...
      <div className="bg-gray-100/80 dark:bg-white/5 backdrop-blur-xl py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: FaSeedling, title: "Inovasi", description: "Mengembangkan dan menerapkan teknologi pertanian yang relevan dengan kebutuhan desa dan petani." },
              { icon: FaHandHoldingHeart, title: "Pemberdayaan", description: "Mendukung petani dengan informasi dan data untuk mendukung pengambilan keputusan." },
              { icon: FaLeaf, title: "Keberlanjutan", description: "Mendorong praktik pertanian yang ramah lingkungan demi masa depan yang lebih baik." },
            ].map((value, index) => (
